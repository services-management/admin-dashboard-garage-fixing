                        ...
                        <div className="modal-body">
                            <div className="form-row">
                                <div className="form-group">
                                    <label className="form-label" htmlFor="sp-name">Name</label>
                                    <input
                                        id="sp-name"
                                ...
                                <div className="form-group">
                                    <label className="form-label" htmlFor="sp-price">Price</label>
                                    <input
                                        id="sp-price"
                                        type="number"
                                        className="form-input"
                            ...
                            <div className="form-row">
                                <div className="form-group">
                                    <label className="form-label" htmlFor="sp-description">Description</label>
                                    <textarea
                                        id="sp-description"
                                        className="form-input"
                            ...
                            <div className="form-row">
                                <div className="form-group">
                                    <label className="form-label" htmlFor="sp-service-input">Services</label>
                            ...
                            <div className="form-row">
                                <div className="form-group">
                                    <label className="form-label" htmlFor="sp-product-input">Products</label>
                                    <div className="selected-items">
                            ...
                            <div className="form-row">
                                <div className="form-group">
                                    <label className="form-label" htmlFor="sp-image">Image</label>
