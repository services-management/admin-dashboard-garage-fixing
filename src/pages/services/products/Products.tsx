                ...
                {products.map((prd) => (
                    <div key={prd.id} className="service-card-enhanced">
                        <div className="service-card-image">
                            <img
                                src={prd.image ?? 'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=400&h=250&fit=crop'}
                                alt={prd.name}
                            />
                ...
                <div className="modal active">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="form-row">
                                <div className="form-group">
                                    <label className="form-label" htmlFor="product-category-input">Categories</label>
