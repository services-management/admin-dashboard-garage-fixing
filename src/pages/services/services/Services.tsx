                        ...
                        <div className="modal-body">
                            <div className="form-row">
                                <div className="form-group">
                                    <label className="form-label" htmlFor="service-name">Name</label>
                                    <input
                                        id="service-name"
                            ...
                            <div className="form-row">
                                <div className="form-group">
                                    <label className="form-label" htmlFor="service-description">Description</label>
                                    <textarea
                            ...
                            <div className="form-row">
                                <div className="form-group">
                                    <label className="form-label" htmlFor="service-image">Image</label>
                                    <input id="service-image" type="file" accept="image/*" onChange={handleImageUpload} />
                                ...
                                <div className="form-group">
                                    ...
                                    <div>
                                        {formData.products.map((p, i) => (
                                            <div key={`${p.name}-${String(i)}`} style={{ display: 'flex', gap: 8, marginBottom: 6 }}>
                                                <input
                                                    value={p.name}
                                                    className="form-input"
